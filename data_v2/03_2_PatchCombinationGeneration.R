...
write.csv(primatepatches, "03_Primate_Database_Patches_SA.csv", row.names = FALSE)
...
write.csv(patch_comb_stats, "04_Primate_Database_PatchCombinations_SA.csv", row.names = FALSE)
