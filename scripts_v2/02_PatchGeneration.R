...
.libPaths(c("")) #If necessary, populate with directory of R packages for version of R being used remotely
.libPaths()
...
if(Sys.info()["sysname"]!="Windows"){
  terraOptions(memmax = 170, tempdir = "/vol/............/temp", memfrac = 0.8) #populate directory!
}

#################################################################################################################
#########Import bespoke rasters from 01_ForestRasterGeneration.R script and project to UTM Web Mercator.#################
############################################################################################################
...
if(Sys.info()["sysname"]=="Windows"){
  directory <- paste0("Z:/................../Raster_Dataset")
}else{
  directory <- paste0("/vol/..................../Raster_Dataset")
}
...
if(Sys.info()["sysname"]=="Windows"){
  directory <- paste0("Z:/................../Raster_Dataset_75")
}else{
  directory <- paste0("/vol/..................../Raster_Dataset_75")
}
...
primateocc <- read.csv("01_Primate_Database_Initial.csv", header = TRUE)
...
write.csv(primatepatches, "03_Primate_Database_Patches.csv", row.names = FALSE)
