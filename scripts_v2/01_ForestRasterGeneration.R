...
primateocc <- read.csv('01_Primate_Database_Initial.csv', header = TRUE, fileEncoding = "latin1")
...
for(i in 1:length(primate_ee_list)){
  ...
  setwd("Z:/........................../Raster_Dataset") #Set directory to global directory of Rasters
...
for(i in 1:length(primate_ee_list)){
  ...
  setwd("Z:/.........................../Raster_Dataset_75") #Set directory to folder for each year. 
