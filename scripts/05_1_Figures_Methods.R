...
primatepatches <-  read.csv('Primate_Database_Patches.csv', header = TRUE)
...
path <- "C:/Users/Tom Beard/Documents/Article/monkey2.png"
...
dev.new()
  ...
  annotation_custom(rasterGrob(img), xmin = thirty_patch[1,]$x + (thirty_patch[1,]$newwidth / 2) - 0.1, xmax = thirty_patch[1,]$x + (thirty_patch[1,]$newwidth / 2) + 0.1, ymin = thirty_patch[1,]$y + (thirty_patch[1,]$newheight /2) - 0.1, ymax = thirty_patch[1,]$y + (thirty_patch[1,]$newheight /2) + 0.1)+
  ...
  annotation_custom(rasterGrob(img), xmin = fifty_patch[1,]$x + (fifty_patch[1,]$newwidth / 2) - 0.1, xmax = fifty_patch[1,]$x + (fifty_patch[1,]$newwidth / 2) + 0.1, ymin = fifty_patch[1,]$y + (fifty_patch[1,]$newheight /2) - 0.1, ymax = fifty_patch[1,]$y + (fifty_patch[1,]$newheight /2) + 0.1)+
  ...
  annotation_custom(rasterGrob(img), xmin = fifty_patch2[2,]$x + (fifty_patch2[2,]$newwidth / 2) - 0.1, xmax = fifty_patch2[2,]$x + (fifty_patch2[2,]$newwidth / 2) + 0.1, ymin = fifty_patch2[2,]$y + (fifty_patch2[2,]$newheight /2) - 0.1, ymax = fifty_patch2[2,]$y + (fifty_patch2[2,]$newheight /2) + 0.1)+
  annotation_custom(rasterGrob(img), xmin = fifty_patch2[3,]$x + (fifty_patch2[3,]$newwidth / 2) - 0.1, xmax = fifty_patch2[3,]$x + (fifty_patch2[3,]$newwidth / 2) + 0.1, ymin = fifty_patch2[3,]$y + (fifty_patch2[3,]$newheight /2) - 0.1, ymax = fifty_patch2[3,]$y + (fifty_patch2[3,]$newheight /2) + 0.1)+
  ...
  annotation_custom(rasterGrob(img), xmin = seventy_patch[1,]$x + (seventy_patch[1,]$newwidth / 2) - 0.1, xmax = seventy_patch[1,]$x + (seventy_patch[1,]$newwidth / 2) + 0.1, ymin = seventy_patch[1,]$y + (seventy_patch[1,]$newheight /2) - 0.1, ymax = seventy_patch[1,]$y + (seventy_patch[1,]$newheight /2) + 0.1)+
  annotation_custom(rasterGrob(img), xmin = seventy_patch[2,]$x + (seventy_patch[2,]$newwidth / 2) - 0.1, xmax = seventy_patch[2,]$x + (seventy_patch[2,]$newwidth / 2) + 0.1, ymin = seventy_patch[2,]$y + (seventy_patch[2,]$newheight /2) - 0.1, ymax = seventy_patch[2,]$y + (seventy_patch[2,]$newheight /2) + 0.1)+
  ...
  annotation_custom(rasterGrob(img), xmin = seventy_patch2[6,]$x + (seventy_patch2[6,]$newwidth / 2) - 0.1, xmax = seventy_patch2[6,]$x + (seventy_patch2[6,]$newwidth / 2) + 0.1, ymin = seventy_patch2[6,]$y + (seventy_patch2[6,]$newheight /2) - 0.1, ymax = seventy_patch2[6,]$y + (seventy_patch2[6,]$newheight /2) + 0.1)+
  annotation_custom(rasterGrob(img), xmin = seventy_patch2[2,]$x + (seventy_patch2[2,]$newwidth / 2) - 0.1, xmax = seventy_patch2[2,]$x + (seventy_patch2[2,]$newwidth / 2) + 0.1, ymin = seventy_patch2[2,]$y + (seventy_patch2[2,]$newheight /2) - 0.1, ymax = seventy_patch2[2,]$y + (seventy_patch2[2,]$newheight /2) + 0.1)+
...
###Figure 3 a), b) and c) - individual 30% forest amount patch combinations for representing MPS change
...
ggplot()+
  ...
  annotation_custom(rasterGrob(img), xmin = thirty_patch3[1,]$x + (thirty_patch3[1,]$newwidth / 2) - 0.1, xmax = thirty_patch3[1,]$x + (thirty_patch3[1,]$newwidth / 2) + 0.1, ymin = thirty_patch3[1,]$y + (thirty_patch3[1,]$newheight /2) - 0.1, ymax = thirty_patch3[1,]$y + (thirty_patch3[1,]$newheight /2) + 0.1)+
  theme_void() +
  coord_fixed(ratio = 1)
...
ggplot()+
  ...
  geom_rect(aes(xmin = scaled_rect[1,1], xmax = scaled_rect[2,1], ymin = scaled_rect[1,2], ymax = scaled_rect[2,2]), fill = NA, colour = "blue", linewidth = 2) +
  annotation_custom(rasterGrob(img), xmin = thirty_patch4[3,]$x + (thirty_patch4[3,]$newwidth / 2) - 0.1, xmax = thirty_patch4[3,]$x + (thirty_patch4[3,]$newwidth / 2) + 0.1, ymin = thirty_patch4[3,]$y + (thirty_patch4[3,]$newheight /2) - 0.1, ymax = thirty_patch4[3,]$y + (thirty_patch4[3,]$newheight /2) + 0.1)+
  theme_void() +
  coord_fixed(ratio = 1)
...
ggplot()+
  ...
  geom_rect(aes(xmin = scaled_rect[1,1], xmax = scaled_rect[2,1], ymin = scaled_rect[1,2], ymax = scaled_rect[2,2]), fill = NA, colour = "blue", linewidth = 2) +
  annotation_custom(rasterGrob(img), xmin = thirty_patch8[3,]$x + (thirty_patch8[3,]$newwidth / 2) - 0.1, xmax = thirty_patch8[3,]$x + (thirty_patch8[3,]$newwidth / 2) + 0.1, ymin = thirty_patch8[3,]$y + (thirty_patch8[3,]$newheight /2) - 0.1, ymax = thirty_patch8[3,]$y + (thirty_patch8[3,]$newheight /2) + 0.1)+
  theme_void() +
  coord_fixed(ratio = 1)
