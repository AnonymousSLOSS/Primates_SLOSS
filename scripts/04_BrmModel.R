...
patch_comb_stats_Din <- read.csv('PatchCombStats_Din.csv', header = TRUE)
...
#Alternative model (using threatened vs non-threatened) for Mean Patch Size method
