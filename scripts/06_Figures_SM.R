...
primatepatches_Din <- read.csv('04_Primate_Database_PatchCombinations.csv', header = TRUE)
primatepatches_Din$patch_area_log <- log10(primatepatches_Din$patch_area)
patchdist <-  read.csv('06_FigS1_PatchDistribution.csv', header = TRUE)
...
patch_comb_dist <-  read.csv('06_FigS2_PatchCombinationsDistribution.csv', header = TRUE)
